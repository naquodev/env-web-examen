...
const timelineEntries: TimelineEntry[] = [
  {
    ...
    text: "Tim Berners-Lee propose un reseau hypertexte mondial au CERN.",
    details:
      "Le memo Information Management: A Proposal imagine un systeme de documents relies par URL, HTML et HTTP afin de partager les connaissances internes entre machines heterogenes.",
    impact: "Pose les briques conceptuelles du Web ouvert et interoperable.",
    sources: [
  ...
  },
  {
    ...
    text: "info.cern.ch, httpd et WorldWideWeb (Nexus) quittent le labo.",
    details:
      "La premiere pile logicielle tourne sur une machine NeXT: serveur httpd, editeur/navigateur et documents demo. HTTP/0.9 assure la livraison des pages texte.",
    impact: "Permet d'auto-heberger un site et democratise la publication Web.",
    sources: [
  ...
  {
    title: "1993 - Mosaic et images inline",
    text: "NCSA Mosaic popularise l'affichage graphique multi-plateforme.",
    details:
      "Disponible sur X11, Windows et Mac, Mosaic affiche texte et images dans la meme fenetre, simplifie l'installation et inspire la creation de Netscape Navigator.",
    impact: "Fait entrer le Web dans le grand public avec une experience visuelle.",
    sources: [
  ...
  },
  {
    ...
    details:
      "Le World Wide Web Consortium est fonde pour harmoniser HTML, HTTP et URI. Netscape lance Navigator et introduit JavaScript (Brendan Eich) tandis qu'Hakon Wium Lie propose CSS pour separer structure et style.",
    impact: "Fixe les regles du jeu tout en ajoutant interactivite et presentation.",
    sources: [
  ...
  },
  {
    ...
    details:
      "CSS2 apporte positionnement, medias et polices, tandis que DOM Level 1 standardise les API pour naviguer et modifier des documents HTML et XML.",
    impact: "Renforce la compatibilite multi-navigateurs et facilite les interfaces dynamiques.",
    sources: [
  ...
  },
  {
    ...
    text: "Le Web 2.0 generalise les applications interactives.",
    details:
      "Gmail, Google Maps et Facebook popularisent Ajax. WHATWG puis W3C redactent HTML5 pour integrer video, audio, canvas et stockage local.",
  ...
  {
    title: "2008-2012 - Chrome, V8, mobile first",
    text: "Chrome introduit V8 tandis que le responsive design devient norme.",
    details:
      "Chrome adopte un moteur JS JIT et un modele multi-process. Ethan Marcotte theorise le responsive design en 2010, et les navigateurs mobiles poussent les web apps.",
    impact: "Booste les performances et impose une approche multi-ecran.",
    sources: [
  ...
  {
    title: "2015-2016 - HTTP/2 et TLS automatise",
    text: "HTTP/2 et Let's Encrypt rendent la vitesse et la securite par defaut.",
    details:
      "HTTP/2 (RFC 7540) apporte multiplexage et compression des entetes. Let's Encrypt automatise la delivrance de certificats gratuits et popularise HSTS.",
    impact: "Generalise le HTTPS et reduit la latence des sites modernes.",
    sources: [
  ...
  },
  {
    ...
    details:
      "L'alliance FIDO et le W3C finalisent WebAuthn Level 1. Les navigateurs acceptent les cles de securite, passkeys et authentificateurs plateforme.",
    impact: "Accelere l'adoption de l'authentification forte cote Web.",
    sources: [
  ...
  },
  {
    ...
    text: "Le Web execute du code natif et accede au GPU moderne.",
    details:
      "WebAssembly devient recommandation W3C en 2020. WebGPU atteint Chrome 113 (2023) et offre un acces de bas niveau au GPU pour graphisme et machine learning.",
    impact: "Permet des experiences quasi natives (3D, IA, montage) dans le navigateur.",
    sources: [
  ...
  },
  {
    ...
    text: "Interop 2024 et Baseline 2024 alignent les navigateurs evergreen.",
    details:
      "Les equipes Chrome, Edge, Firefox et Safari ciblent 26 themes critiques (forms, scroll, accessibility). Baseline 2024 liste les APIs supportees par tous les navigateurs modernes.",
    impact: "Simplifie la livraison sans polyfills et fiabilise les roadmaps produit.",
    sources: [
...
const supplement = (
  <div className="space-y-4">
    <header className="space-y-1">
      <p className="text-xs uppercase tracking-[0.35em] text-white/60">Synthese</p>
...
const TimelineSlide: SlideComponent = ({ index, total }) => (
  <SlideTemplate
    ...
    description="Des memos du CERN aux programmes Interop 2025, retrouvez les dates et innovations clefs qui ont faconne la plateforme Web."
